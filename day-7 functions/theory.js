...
// Functions are nothing but a block of code which performs a specific task when ever it is invoked or called.
...
//Types of functions :
      ...
      // Normal function
      function greetUser(){
        console.log(`Heloooo! good morning`);
      }
      greetUser();
      greetUser();
      greetUser();
...
// parameters is nothing but temporary variables
// -----------------------
